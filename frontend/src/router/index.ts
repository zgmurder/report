  ...
  routes: [
    ...
    { path: '/login', component: () => import('@/views/LoginView.vue'), meta: { public: true } },
    {
      ...
      children: [
        ...
        { path: 'tags', component: () => import('@/views/TagWorkbenchView.vue'), meta: { title: '研判包' } },
        { path: 'warnings', component: () => import('@/views/WarningWorkbenchView.vue'), meta: { title: '预警' } },
        { path: 'alarm-tagging', component: () => import('@/views/AlarmTaggingV2View.vue'), meta: { title: '警情打标' } },
